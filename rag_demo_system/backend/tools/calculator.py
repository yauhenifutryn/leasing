        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "ВЫЗЫВАЙ СРАЗУ как только клиент назвал предмет лизинга и стоимость. "
                    "НЕ СПРАШИВАЙ дополнительные параметры (срок, аванс, валюту) — у них есть значения по умолчанию. "
                    "Достаточно subject и cost чтобы вызвать калькулятор."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
